...
data = data[data['name_indicator'] == 'Casos de COVID-19 a Barcelona (acumulat)']
...
plt.ylabel('Accumulated Covid-19 Cases (thou', fontsize=18)
...
ani.save('covid_accumulated_cases_bcn.mp4', writer=writer)
print('end')
